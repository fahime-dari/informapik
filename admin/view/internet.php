                ...
                <div class="column">
                    <div class="card">
                      <i class="fa-light fa-router"></i>
                        <h2>Installation et maintenance de parcs informatiques (micro-ordinateurs et réseaux)</h2>
                    </div>
                </div>
                <div>
                    <div class="card">
                        <i class="fa-solid fa-envelope-circle-check"></i>
                        <h2>Gestion de la messagerie électronique, (comptes mails, identifiants, mots de passe, redirection...)</h2>
                 ...
                 <div class="column">
                    <div class="card">
                        ...
                        <h2> Gestion de la sécurité (protection antivirale, pare-feu...)</h2>
                    </div>
                </div>
                 <div class="column">
                    <div class="card">
                        <i class="fa-solid fa-user-unlock"></i>
                        <h2>Gestion des droits des utilisateurs (accès au réseau)</h2>
                    </div>
                </div>
            </div>
        </div>
...
<p>Informapik située à REIMS.<br>Nous vous accompagnons de A à Z.
  ...
  <div class="footer-col">
    ...
    <ul>
      ...
      <li><a href="acces_a_distance.html">Accès à distance</a></li>
  ...
  <div class="footer-col">
    <h4>Contact</h4>
    <ul>
      <li><a href="#" class="nav__link--anchor nav_link--anchor-primary">CONTACT / RDV</a></li>
