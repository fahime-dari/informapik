    ...
    <nav>
        ...
        <div class="mainpage-text"> 
            ...
            <?php 
              ...
              $req ="SELECT * FROM services_r WHERE id_r= 5";
              $res = $dbco->query($req);

              if ($res->rowCount() > 0) {
                while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
                  echo "<h1>" . $row['titre_r'] . "</h1>";
                  echo "<p>" .$row['texte_r']."</p>";
                }
              } else {
        ...
        <div id="services">
            ...
            <div class="card-container">
                <div class="column">
                    <div class="card">
                    <?php
                          $req ="SELECT * FROM services_r WHERE id_r= 1";
                          $res = $dbco->query($req);
                          
                          if ($res->rowCount() > 0) {
                            while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
                              echo '<i class="'.$row['icone_r'].'"></i>';
                              echo "<h2>" . $row['titre_r']. "</h2>";
                              echo "<p>" .$row['texte_r']."</p>";
                            }
                          } else {
                            echo "Aucun enregistrement.";
                ...
                <div class="column">
                    <div class="card">
                        <?php
                          $req ="SELECT * FROM services_r WHERE id_r = 2";
                          $res = $dbco->query($req);
                        ...
                        ?>
                        <a href="/code/view/saisie_contact.php">En savoir plus</a>
                    </div>
                </div>
                <div class="column">
                    <div class="card">
                        <?php
                          $req ="SELECT * FROM services_r WHERE id_r = 3";
                          $res = $dbco->query($req);
                 ...
                 <div class="column">
                    <div class="card">
                       <?php
                          $req ="SELECT * FROM services_r WHERE id_r = 4";
                          $res = $dbco->query($req);
    ...
    <section class="carousel">
      <div class="slider">
        <div class="slide-track">
          <div class="slide">
            <img src="/code/images/amd.png" height="100"  alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/asus.png" height="100"  alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/canon.png" height="100"  alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/hp.png" height="100"  alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/intel.webp" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/linux.png"   alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/logitech.png" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/microsoft-png-hd-pictures-the-new-microsoft-logo-in-ultra-hd-glory-3650.png" height="100" width="250" alt="" />
          </div>
          
          <div class="slide">
            <img src="/code/images/amd.png" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/asus.png" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/canon.png" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/hp.png" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/intel.webp" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/linux.png" height="100" width="250" alt="" />
          </div>
          <div class="slide">
            <img src="/code/images/logitech.png" height="100" width="250" alt="" />
          </div>
